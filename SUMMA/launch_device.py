"""SUMMA device launcher (appliance python, cloud artifact_<cfg>)."""
import argparse
import json
import random
import time
...
def parse_args():
    parser = argparse.ArgumentParser(description="SUMMA GEMM on WSE-3")
...
def main():
    ...
    with SdkRuntime(artifact_id, simulator=args.simulator, disable_version_check=True) as runner:
        ...
        W_u32 = cast_tensor_u32(hc.tile_W(tensor_W, P, Kt, Nt))
